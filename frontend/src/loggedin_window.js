...
let FragLoggedinWindow = class FragLoggedinWindow extends Adw.ApplicationWindow {
    constructor(params = {}) {
        super(params);
        //later to be replaced with real data
        this.tasks_mock = ["Task1", "Task2", "Task3", "Task4"];
        this.projects = [
            {
                id: 1,
...
FragLoggedinWindow = __decorate([
    registerClass({
        GTypeName: 'FragLoggedinWindow',
        Template: 'resource:///com/github/sorry4nothing/Fragile/loggedin_window.ui',
        Properties: {
            // details page
            'tasks_mock': GObject.param_spec_variant('testlist', 'Testlist', 'Testlist', new GLib.VariantType('as'), null, GObject.ParamFlags.READWRITE),
            // import page,
